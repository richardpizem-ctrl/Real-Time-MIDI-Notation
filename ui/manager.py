    ...
    def run(self):
        ...
        while running:
            for event in pygame.event.get():
                ...
                # 🔥 Preposielame eventy rendereru (dragovanie, scroll)
